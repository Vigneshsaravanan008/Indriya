 ...
 <section class="banner-two-area">
    <div class="swiper banner-two__slider">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="slide-bg" data-background="{{asset("site-images/home/indriya_education_1.jpeg")}}"></div>
                <div class="container">
                    <div class="banner-two__content">
                ...
                <div class="about__content">
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-4 mt-40 wow fadeInDown">
                        <div class="btn-two">
                            ...
                            <a href="{{route("site.aboutus")}}" class="btn-inner">
                                <span class="btn-text">
                                    About Us
                                </span>
                            </a>
    ...
    <div class="row g-0">
        <div class="col-md-5">
            <div class="video__left-item bg-image h-100"
                data-background="{{asset("site-images/about/food.jpg")}}">

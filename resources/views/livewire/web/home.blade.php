...
<div>
 <section class="banner-two-area">
    ...
    <div class="banner-two__shape wow slideInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
        <img class="banner__line__animation" src="{{asset("web-assets/assets/images/shape/banner-line.png")}}" alt="shape">
    </div>
</section>
        ...
        <div class="row g-2 align-items-center">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="about__image">
                    ...
                    <div class="sm-image">
                        <img src="{{asset("web-assets/assets/images/about/about-image2.png")}}" alt="image">
                    </div>
                    <div class="image">
                        <img src="{{asset("web-assets/assets/images/about/about-image1.jpg")}}" alt="image">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="about__content">
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-4 mt-40 wow fadeInDown"
                        ...
                        <div class="about-info">
                            <img src="{{asset("web-assets/assets/images/about/about-info.png")}}" alt="image">
                            <div class="con">
                                <h5 class="fs-16">Albert Flores</h5>
                                <span class="sm-font">CEO, Donatim</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row g-0">
        <div class="col-md-5">
            <div class="video__left-item bg-image h-100"
                data-background="{{asset("web-assets/assets/images/video/video-left-image.jpg")}}">
        ...
        <div class="col-md-7">
            <div class="video__right-item bg-image pt-120 pb-120 pl-80"
                data-background="{{asset("web-assets/assets/images/video/video-right-image.jpg")}}">
        ...
        <div class="swiper cause__slider">
            <div class="swiper-wrapper py-4">
                ...
                <div class="swiper-slide">
                    <div class="cause__item">
                        <div class="cause__image image">
                            <img src="{{asset("web-assets/assets/images/cause/cause-image2.jpg")}}" alt="image">
                ...
                <div class="swiper-slide">
                    <div class="cause__item">
                        <div class="cause__image image">
                            <img src="{{asset("web-assets/assets/images/cause/cause-image3.jpg")}}" alt="image">
                ...
                <div class="swiper-slide">
                    <div class="cause__item">
                        <div class="cause__image image">
                            <img src="{{asset("web-assets/assets/images/cause/cause-image4.jpg")}}" alt="image">
    ...
    <div class="container-fluid">
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-6 wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                <div class="event__item h-100">
                    <div class="image h-100">
                        <img class="h-100" src="{{asset("web-assets/assets/images/event/event-image2.jpg")}}" alt="image">
                    </div>
                    <div class="event__content">
                        <ul class="mb-4">
                            <li>
            ...
            <div class="col-xl-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="event__item h-100">
                    <div class="image h-100">
                        <img class="h-100" src="{{asset("web-assets/assets/images/event/event-image3.jpg")}}" alt="image">
                    </div>
                    <div class="event__content">
                        <ul class="mb-4">
                            <li>
            ...
            <div class="col-xl-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="event__item h-100">
                    <div class="image h-100">
                        <img class="h-100" src="{{asset("web-assets/assets/images/event/event-image4.jpg")}}" alt="image">
                    </div>
                    <div class="event__content">
                        <ul class="mb-4">
                            <li>
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="testimonial__item">
                    ...
                    <div class="top">
                        <div class="image">
                            <img src="{{asset("web-assets/assets/images/testimonial/testimonial-image1.png")}}" alt="image">
            ...
            <div class="swiper-slide">
                <div class="testimonial__item">
                    ...
                    <div class="top">
                        <div class="image">
                            <img src="{{asset("web-assets/assets/images/testimonial/testimonial-image2.png")}}" alt="image">
                            <svg width="32" height="28" viewBox="0 0 32 28" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M29 28C30.625 28 32 26.625 32 25V10C32 4.4375 27.5 0 22 0H21.5C20.625 0 20 0.625 20 1.5V4.5C20 5.3125 20.625 6 21.5 6H22C24.1875 6 26 7.75 26 10V14H21C19.3125 14 18 15.3125 18 17V25C18 26.625 19.3125 28 21 28H29ZM11 28C12.625 28 14 26.625 14 25V10C14 4.4375 9.5 0 4 0H3.5C2.625 0 2 0.625 2 1.5V4.5C2 5.3125 2.625 6 3.5 6H4C6.1875 6 8 7.75 8 10V14H3C1.3125 14 0 15.3125 0 17V25C0 26.625 1.3125 28 3 28H11Z"
            ...
            <div class="swiper-slide">
                <div class="testimonial__item">
                    ...
                    <div class="top">
                        <div class="image">
                            <img src="{{asset("web-assets/assets/images/testimonial/testimonial-image3.png")}}" alt="image">
                            <svg width="32" height="28" viewBox="0 0 32 28" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M29 28C30.625 28 32 26.625 32 25V10C32 4.4375 27.5 0 22 0H21.5C20.625 0 20 0.625 20 1.5V4.5C20 5.3125 20.625 6 21.5 6H22C24.1875 6 26 7.75 26 10V14H21C19.3125 14 18 15.3125 18 17V25C18 26.625 19.3125 28 21 28H29ZM11 28C12.625 28 14 26.625 14 25V10C14 4.4375 9.5 0 4 0H3.5C2.625 0 2 0.625 2 1.5V4.5C2 5.3125 2.625 6 3.5 6H4C6.1875 6 8 7.75 8 10V14H3C1.3125 14 0 15.3125 0 17V25C0 26.625 1.3125 28 3 28H11Z"
            ...
            <div class="swiper-slide">
                <div class="testimonial__item">
                    ...
                    <div class="top">
                        <div class="image">
                            <img src="{{asset("web-assets/assets/images/testimonial/testimonial-image4.png")}}" alt="image">
                            <svg width="32" height="28" viewBox="0 0 32 28" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M29 28C30.625 28 32 26.625 32 25V10C32 4.4375 27.5 0 22 0H21.5C20.625 0 20 0.625 20 1.5V4.5C20 5.3125 20.625 6 21.5 6H22C24.1875 6 26 7.75 26 10V14H21C19.3125 14 18 15.3125 18 17V25C18 26.625 19.3125 28 21 28H29ZM11 28C12.625 28 14 26.625 14 25V10C14 4.4375 9.5 0 4 0H3.5C2.625 0 2 0.625 2 1.5V4.5C2 5.3125 2.625 6 3.5 6H4C6.1875 6 8 7.75 8 10V14H3C1.3125 14 0 15.3125 0 17V25C0 26.625 1.3125 28 3 28H11Z"
        ...
        <div class="row g-4">
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                <div class="blog__item">
                    <div class="image">
                        <img src="{{asset("web-assets/assets/images/blog/blog-image1.jpg")}}" alt="image">
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="blog__item">
                    <div class="image">
                        <img src="{{asset("web-assets/assets/images/blog/blog-image2.jpg")}}" alt="image">
            ...
            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="blog__item">
                    <div class="image">
                        <img src="{{asset("web-assets/assets/images/blog/blog-image3.jpg")}}" alt="image">

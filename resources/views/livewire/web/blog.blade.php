...
<div>
    <section wire:ignore>
        <div class="banner__inner-page pt-160 pb-160 bg-image" data-background="{{asset("web-assets/assets/images/banner/banner-inner-page.jpg")}}">
            <div class="container">
                    ...
                    <div class="blog-single__right-item">
                        <div class="item shadow mb-30">
                            ...
                            <div class="serach-bar">
                                <input type="text" placeholder="Search here" wire:model.live="blogName">
                        ...
                        <div class="item shadow mb-30">
                            ...
                            <ul class="category">
                                @forelse($blog_categories as $category)
                                    <li><a href="{{route('site.blogcategory',$category->slug)}}">{{$category->name}}</a> <span>({{$category->blogs->count()}})</span></li>
                                @empty
                        ...
                        <div class="item shadow mb-30">
                            ...
                            <ul class="single-post">
                                ...
                                <li>
                                    <img src="{{asset($recent_blog->banner_image)}}" alt="image" width="100px" height="100px">
                                    <div class="con">
                                        <h6><a href="{{route('site.viewblog',$recent_blog->slug)}}" class="primary-hover">{{$recent_blog->name}}</a></h6>
                                        <span>{{Carbon\Carbon::parse($recent_blog->created_at)->format('d ,M Y')}}</span>
                                    </div>
                                </li>
                                @endforeach
                            </ul>
